...
import { ORDER_COLUMN } from '@/components/account/orders/orders-table/data-table-columns'
...
export const DUMMY_ORDERS: OrderTableColumns[] = [
	{
		...
		status: <CustomBadge status='Processing' />,
		total: '$100.00',
	},
	{
		orderNumber: '002',
		...
		status: <CustomBadge status='Shipped' />,
		total: '$50.00',
	},
	{
		orderNumber: '003',
		...
		status: <CustomBadge status='Delivered' />,
		total: '$200.00',
	},
]
export default function Orders({}: Props) {
	return (
		<div>
			{/* tab section */}
			<OrderTab />
			<OrderDataTable data={DUMMY_ORDERS} columns={ORDER_COLUMN} />
		</div>
	)
}
