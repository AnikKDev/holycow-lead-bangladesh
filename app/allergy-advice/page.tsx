...
export default function AllergyAdvice({}: Props) {
	return (
		<>
			<div className='mx-auto max-w-7xl py-11 text-center'>
				<section className='content fullwidth text-center'>
					<article
						id='post-65'
						className='post-65 page type-page status-publish has-post-thumbnail hentry'
					>
						<p>
						...
						<div className='responsive-table'>
							<table
								id='tablepress-1'
								className='tablepress tablepress-id-1 allergen'
							>
								<thead>
									<tr className='row-1'>
									...
									<tr className='row-2'>
										...
										<td className='column-3'>
											<img
												...
												height='100'
												alt=''
												data-src='https://holycowonline.com/wp-content/uploads/2021/10/full-image-url-here.jpg'
											/>
											GLUTEN/WHEAT
										</td>
