...
export default function FooterUpdated({}: Props) {
	return (
		<footer
			id='footer-container'
			className='bg-primary text-secondary mobile-sm:p-3 mobile-md:p-3 _desktop-sm:p-20 _desktop-sm:pb-12 _desktop-md:p-20 _desktop-md:pb-12'
		>
			...
			<div className='_desktop-lg:justify-items-center grid grid-cols-auto-fit-minmax  gap-5 mobile-sm:justify-items-start  _desktop-sm:grid-cols-4 _desktop-sm:justify-items-center _desktop-md:grid-cols-4 _desktop-md:justify-items-center'>
				<FooterInsta />
				{/* <FooterLocations /> */}
				<FooterAbout />
				<ExtraLinks />
